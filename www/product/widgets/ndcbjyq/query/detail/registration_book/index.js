...
pug_mixins["nav-heavy"] = pug_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_indent.push('');
pug_mixins["nav"].call({
block: function(){
...
attributes: pug_merge([{"class": "nav-heavy nav-pills"},attributes])
});
pug_indent.pop();
};
...
pug_mixins["textblock-t"] = pug_interp = function(text, field, colspan){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_indent.push('');
...
pug_indent.pop();
pug_indent.push('');
pug_mixins["editor"](field, text, 'textblock');
pug_indent.pop();
}
}, colspan);
pug_indent.pop();
...
block: function(){
pug_indent.push('');
pug_mixins["modal-heading"]('登记簿', '详情');
pug_indent.pop();
}
});
pug_indent.pop();
