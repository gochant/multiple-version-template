...
this["JST"]["www/product/widgets/ndcbjyq/workdeck/view/handle/index.jade"] = function pug_attr(t,e,n,r){if(e===!1||null==e||!e&&("class"===t||"style"===t))return"";if(e===!0)return" "+(r?t:t+'="'+t+'"');if("function"==typeof e.toISOString)e=e.toISOString();else if("string"!=typeof e&&(e=JSON.stringify(e),!n&&-1!==e.indexOf('"')))return" "+t+"='"+e.replace(/'/g,"&#39;")+"'";return n&&(e=pug_escape(e))," "+t+'="'+e+'"'}
...
function pug_style(r){if(!r)return"";if("object"==typeof r){var e="",t="";for(var n in r)pug_has_own_property.call(r,n)&&(e=e+t+n+":"+r[n],t=";");return e}return r=""+r,";"===r[r.length-1]?r.slice(0,-1):r}function compiled(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_indent = [];
...
pug_mixins["panel-t"] = pug_interp = function(title, type){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_indent.push('');
...
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Ch3 class=\"panel-title\"\u003E" + (pug_escape(null == (pug_interp = title) ? "" : pug_interp)) + "\u003C\u002Fh3\u003E\n";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
pug_indent.push('');
block && block();
...
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cinput" + (" type=\"checkbox\""+pug_attr("data-bind", bind, true, false)) + "\u002F\u003E" + (pug_escape(null == (pug_interp = text) ? "" : pug_interp)) + "\n  ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003C\u002Flabel\u003E\n";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
...
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cinput" + (" type=\"checkbox\""+pug_attr("data-bind", bind, true, false)+pug_attr("value", item.value, true, false)) + "\u002F\u003E" + (pug_escape(null == (pug_interp = item.name) ? "" : pug_interp)) + "\n  ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003C\u002Flabel\u003E";
  }
...
pug_mixins["quick-access"] = pug_interp = function(action, text){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\n";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cdiv" + (pug_attrs(pug_merge([{"class": "btn btn-default quick-access","data-action": pug_escape(action)},attributes]), false)) + "\u003E\u003Ci class=\"fa fa-4x fa-bar-chart-o\"\u003E\u003C\u002Fi\u003E\n  ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Ch5\u003E" + (pug_escape(null == (pug_interp = text) ? "" : pug_interp)) + "\u003C\u002Fh5\u003E\n";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
};
pug_indent.push('');
...
pug_html = pug_html + "\n";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cdiv class=\"section-header\"\u003E登记业务\u003C\u002Fdiv\u003E\n";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cul class=\"list-inline\"\u003E\n  ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cli\u003E";
pug_indent.push('    ');
...
pug_indent.pop();
pug_html = pug_html + "\n\u003Cscript id=\"modal-template\" type=\"text\u002Ftemplate\"\u003E\n  \u003Cdiv class=\"modal modal-classy fullscreen fade\"\u003E\n    \u003Cdiv class=\"modal-dialog\"\u003E\n      \u003Cdiv class=\"modal-content fn-wnd\"\u003E\u003C\u002Fdiv\u003E\n    \u003C\u002Fdiv\u003E\n  \u003C\u002Fdiv\u003E\n\u003C\u002Fscript\u003E";;return pug_html;};
